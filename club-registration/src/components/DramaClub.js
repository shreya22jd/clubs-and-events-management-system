...
const DramaClub = () => {
  const clubDetails = {
    name: "Drama Club",
    description: "Showcases theatrical talent through plays and performances.",
    founded: "2015",
  };

  const members = [
    { id: 1, name: "Arjun Nair", role: "Director", email: "arjun@example.com" },
    { id: 2, name: "Priya Sharma", role: "Lead Actor", email: "priya@example.com" },
  ];
...
const styles = {
  ...
  clubHeader: {
    background: 'linear-gradient(45deg, rgba(153, 0, 51, 0.8), rgba(204, 0, 102, 0.8))',
